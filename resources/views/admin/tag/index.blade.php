            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-1 mb-3">
                        {{--                ссылка на категории, admin.tag.create - имя роута--}}
                        ...
                        <div class="card">
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                    {{--                                из IndexController получаем $tags и раскладываем значения по столбцам--}}
                                    @foreach($tags as $tag)
                                        <tr>
                                            <td>{{ $tag->id }}</td>
                                            <td>{{ $tag->title }}</td>
                                            {{--                                    id - на основании этого id Ларавел будет искать тэг и подставлять его в роут--}}
