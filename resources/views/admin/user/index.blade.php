            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-1 mb-3">
                        {{--                ссылка на категории, admin.user.create - имя роута--}}
                        ...
                        <div class="card">
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                    {{--                                из IndexController получаем $users и раскладываем значения по столбцам--}}
                                    @foreach($users as $user)
                                        <tr>
                                            <td>{{ $user->id }}</td>
                                            <td>{{ $user->name }}</td>
                                            {{--                                    id - на основании этого id Ларавел будет искать категорию и подставлять её в роут--}}
